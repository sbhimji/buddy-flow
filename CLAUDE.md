...
concentrating across ~60 tickers grouped into baskets, whether it is rotating, and whether
the buying is broad and aggressive or thin and passive. Primary user moment: 09:30–10:30 ET.
...
- `docs/morning-tape-dev-plan-v1.md` — the operative plan. Phases 0–6, stories, the 19-item
  fix list (Appendix A), and the trader Decision Sheet D1–D12 (Appendix B).
